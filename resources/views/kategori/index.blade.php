...
<tbody>
  ...
  <tr>
     ...
     <td>{{$item->nama}}</td>
     <td>
         <a href="/kategori/edit/{{$item->id}}" class="btn btn-warning btn-bg"><i class="fa-solid fa-edit"></i></a>
         <!-- |<form action="{{route('kategori.destroy', $item->id)}}" method="POST">
           @csrf
           @method('delete')
           <button class="btn btn-sm btn-danger" type="sumbit"><i class="fa-solid fa-trash"></i></button>
          </form> -->
